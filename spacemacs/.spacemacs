...
This function should only modify configuration layer settings."
  (setq-default
   ...
   '(
     (evil-text-object-go :location "~/source/evil-text-object-go")
     (evil-text-object-python :location "~/source/evil-text-object-python")
     )
